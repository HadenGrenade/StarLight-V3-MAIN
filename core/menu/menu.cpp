		...
		JunkCodeTutorial();
			...
			if (SkinTab == 0) {
				zgui::begin_groupbox("Skinchanger Main", { 385,325 });
				{
					...
					case 1:
						zgui::combobox("Bloodhound Skin", { "Snakebite", "Guerrilla", "Charred", "Bronzed" }, variables::bloodhound_skin);
						break;
					case 2:
						zgui::combobox("Sport Skin", { "Vice", "Amphibious", "Omega", "Bronze Morph", "Pandora's Box", "Superconductor", "Hedge Maze", "Arid" }, variables::sport_skin);
						break;
					case 3:
						zgui::combobox("Driver Skin", { "King Snake", "Imperial Plaid", "Overtake", "Racing Green", "Crimson Weave", "Diamondback", "Lunar Weave", "Convoy" }, variables::driver_skin);
						break;
					case 4:
						zgui::combobox("Hand Wrap Skin", { "Cobalt Skulls", "Overprint", "Arboreal", "Duct Tape", "Slaughter", "Badlands", "Leather", "Spruce DDPAT" }, variables::handwrap_skin);
						break;
					case 5:
						zgui::combobox("Moto Skin", { "POW!", "Turtle", "Polygon", "Transport", "Spearmint", "Boom!", "Cool Mint", "Eclipse" }, variables::moto_skin);
						break;
					case 6:
						zgui::combobox("Specialist Skin", { "Fade", "Crimson Web", "Mogul", "Buckshot", "Crimson Kimono", "Emerald Web", "Foundation", "Forest DDPAT" }, variables::specialist_skin);
						break;
					case 7:
						zgui::combobox("Hydra Skin", { "Emerald", "Mangrove", "Case Hardened", "Rattler" }, variables::hydra_skin);
						break;
					}
